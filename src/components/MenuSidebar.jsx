  ...
  >
    {
      ...
      categories.map((category) => (
        <button
          ...
          onClick={() => setselectedCategory2(category.name)}
          style={{
            ...
            background: category.name === selectedCategory2 && '#5b585c',
            color: 'white',
          }}
        ...
        >
          ...
          <span
            style={{
              // set the opacity to 1 if the current category's name is equal to the selectedCategory2 constant, and set it to 0.8 otherwise
              opacity: category.name === selectedCategory2 ? '1' : '0.8',
            }}
          >
            {category.name}
          </span>
